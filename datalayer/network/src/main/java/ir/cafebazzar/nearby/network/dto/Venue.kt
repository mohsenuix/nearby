package ir.cafebazzar.nearby.network.dto
...
sealed class Venue {
    ...
    data class VenuesResponse(@SerializedName("venues")
                              val venues: List<ir.cafebazzar.nearby.network.dto.Venue.Venue>)

    data class VenueResponse(@SerializedName("venue")
                             val venue: ir.cafebazzar.nearby.network.dto.Venue.Venue)
